...
<body>
    ...
    <div class="equipe">
      ...
      <div class="card" style="width: 18rem;">
        <img src="../view_img/equipe_lauraFernandes.png" class="card-img2" alt="...">
      <div class="card-body">
        <h5 class="card-title">Laura Fernandes</h5>
          ...
          <p class="card-descricao">
            Especializada em ensinar e modificar comportamentos de animais. Utiliza técnicas de reforço positivo para
            ajudar os pets a aprender comandos básicos, truques e a se comportar adequadamente em diversas situações.
          </p>
      </div><!--Fecha 'card'-->
    </div><!--Fecha 'card-body'-->

    <div class="card" style="width: 18rem;">
        <img src="../view_img/equipe_marianaCarvalho.png" class="card-img2" alt="...">
      <div class="card-body">
        <h5 class="card-title">Mariana Carvalho</h5>
          ...
          <p class="card-descricao">
            Responsável pelos cuidados estéticos e de higiene dos animais de estimação.
            Realiza banhos, tosa, escovação e corte de unhas, garantindo que os pets fiquem limpos, saudáveis e bem apresentados.
          </p>
      </div><!--Fecha 'card'-->
    </div><!--Fecha 'card-body'-->
