...
insert into cargo(id_setor, nome) values (4, 'Cuidador'); 
 ...
 INSERT INTO usuario (nome, cpf, data_nascimento, id_setor, id_cargo, email, senha, ativo, imagem) VALUES  
...
('Poliana Padilha','56789012344', '1987-11-07', 2, 5, 'ppadilha@gmail.com', md5('123456'), 1, 'equipe_polianaPadilha.png'),  
('Luísa Kimura','56779012341', '1987-11-25', 2, 5, 'kimura.luisa@gmail.com', md5('123456'), 1, 'equipe-luisaKimura.png'),  
('Rebecca Macedo','67890123455', '1991-02-19', 2, 5, 'rebeccamac@gmail.com', md5('123456'), 1, 'equipe_rebeccaMacedo.png'),  
('Beatriz Costa','89012345677', '1993-04-13', 2, 17, 'biacosta1998@gmail.com', md5('123456'), 1, 'equipe_beatrizCosta.png'),  
('Fabiana Almeida','90123456788', '1994-09-17', 2, 17, 'almeidafabi79@gmail.com', md5('123456'), 1, 'equipe_fabianaAlmeida.png'),  
('Victor Hugo','01234567899', '1995-12-28', 2, 17, 'vichugo@gmail.com', md5('123456'), 1, 'equipe_victorHugo.png'),  
('Felipe Carvalho','12345678001', '1984-05-09', 2, 17, 'lipecarvalho@gmail.com', md5('123456'), 1, 'equipe_felipeCarvalho.png'),  
('Daniel Santos','23456789112', '1988-10-14', 2, 6, 'danielsantos@gmail.com', md5('123456'), 1, 'equipe_danielSantos.png'),  
('Tatiane Souza','34567890223', '1996-01-20', 2, 7, 'tatisouza@gmail.com', md5('123456'), 1, 'equipe_tatianeSouza.png'),  
('Roberta Martins','45678901334', '1981-03-29', 2, 8, 'robertama@gmail.com', md5('123456'), 1, 'equipe_robertaMartins.png'),  
('Marcia Ferreira','56789012445', '1997-07-02', 2, 9, 'ffmarcia8@gmail.com', md5('123456'), 1, 'equipe_marciaFerreira.png'),  
('Isaque Nobrega','67890123556', '1998-09-21', 2, 10, 'inobrega@gmail.com', md5('123456'), 1, 'equipe_isaqueNobrega.png'),  
('Emily Gonzaga','78901234667', '1986-11-30', 2, 11, 'gonzagaemily2010@gmail.com', md5('123456'), 1, 'equipe-emilyGonzaga.png'),  
('Wesley Silva','89012345778', '1992-06-06', 2, 12, 'wesley.sil.va@gmail.com', md5('123456'), 1, 'equipe_wesleySilva.png'),  
('Luana Cardoso','90123456889', '1989-12-12', 2, 13, 'cardoso.luana@gmail.com', md5('123456'), 1, 'equipe_luanaCardoso.png'),  
('Alicia Correia','01234567990', '1993-04-01', 2, 14, 'aliciacorreia12@gmail.com', md5('123456'), 1, 'equipe_aliciaCorreia.png'),  
('Gregório Casa','12345678111', '1985-08-19', 2, 15, 'drcasa@gmail.com', md5('123456'), 1, 'equipe-gregoriaCasa.png'),  
('Carlos Almeida','23456789222', '1991-03-15', 2, 16, 'carlos.a.almeida@gmail.com', md5('123456'), 1, 'equipe_carlosAlmeida.png'),  
('Marcela Costa','34567890333', '1982-11-23', 2, 16, 'marcosta@gmail.com', md5('123456'),1, 'equipe_marcelaCosta.png'),  
('Leandro Ribeiro','45678901444', '1997-10-09', 2, 16, 'ribleandrinho@gmail.com', md5('123456'), 1, 'equipe_leandroRibeiro.png'),  
('Priscilla Carvalho','56789012555', '1990-05-27', 2, 17, 'pricarv@gmail.com', md5('123456'), 1, 'equipe_priscillaCarvalho.png'),  
('Vinicius Correia','26489012555', '1990-05-27', 2, 17, 'vinicor12@gmail.com', md5('123456'), 1, 'equipe_viniciusCorreia.png'),  
('Pedro Oliveira','63889012555', '1990-05-27', 2, 17, 'peoliveira@gmail.com', md5('123456'), 1, 'equipe-pedroOliveira.png'),  
('Lilian Souza','46489012555', '1990-05-27', 2, 17, 'pricarv@gmail.com', md5('123456'), 1, 'equipe_lilianSouza.png'),
('Dante Magalhães','22232145678', '1990-05-04', 3, 18, 'dante@gmail.com', md5('123456'), 1, ''),
('Camila Lima','22232145611', '1992-10-02', 3, 18, 'calima@gmail.com', md5('123456'), 1, ''),
('Bianca Machado','12332145611', '1998-10-25', 3, 19, 'biamachado@gmail.com', md5('123456'), 1, ''),
('Pedro Martins','25532145623', '1997-05-20', 3, 19, 'pedromar@gmail.com', md5('123456'), 1, ''),
('Marisa Ribeiro','45698745623', '1996-10-02', 3, 19, 'marisaribeiro@gmail.com', md5('123456'), 1, ''),
('Laura Fernandes','52639874515', '1994-02-27', 4, 20, 'laufer@gmail.com', md5('123456'), 1, 'equipe_lauraFernandes.png'),
('Lucas Almeida','52615474515', '1999-03-15', 4, 20, 'lucas.almeida@gmail.com', md5('123456'), 1, 'equipe_lucasAlmeida.png'),
('Mariana Carvalho','52622274123', '1989-07-09', 4, 21, 'maricarvalho@gmail.com', md5('123456'), 1, 'equipe_marianaCarvalho.png'),
('Arthur Santos','52639874888', '1992-10-31', 4, 21, 'arthur.santos@gmail.com', md5('123456'), 1, 'equipe_arthurSantos.png'),
('Miguel Ferreira','52124574515', '1994-06-16', 4, 21, 'miguelfer@gmail.com', md5('123456'), 1, 'equipe_miguelFerreira.png');
...
('Casinhas e Transporte'); 
 ...
 INSERT INTO produto (id_categoria, id_marca, nome, descricao, data_validade, valor, peso, qtde_estoque, imagem) VALUES  

 (1, 1, 'Antipulgas', 'Produto para controle de pulgas em cães e gatos.', '2025-12-31', 49.99, 0.15, 100, 'produto_antiPulgas.png'),  
...
(1, 6, 'Vermífugo', 'Medicamento para controle de vermes em cães e gatos.', '2025-10-15', 29.99, 0.10, 200, 'produto_vermifugo.png'),  

  

(1, 6, 'Anti-Inflamatório', 'Medicamento anti-inflamatório para pets.', '2025-09-30', 59.99, 0.25, 80, 'produto_antiInflamatorio.png'),  

  

(1, 6, 'AntiParasitas', 'Tratamento para controle de parasitas em geral.', '2025-08-31', 45.99, 0.18, 120, 'produto_antiParasitas.png'),  

  

(1, 6, 'Antibiótico', 'Antibiótico para infecções em pets.', '2025-07-20', 69.99, 0.30, 90, 'produto_antibiotico.png'),  

  

(2, 5, 'Vitaminas', 'Suplemento vitamínico para pets.', '2025-06-30', 25.99, 0.12, 250, 'produto_vitamina.png'),  

  

(2, 5, 'Suplementos', 'Suplementos diversos para saúde dos animais.', '2025-05-15', 34.99, 0.20, 110, 'produto_suplemento.png'),  

  

(2, 5, 'Tratamento para Pele', 'Produto para tratamento de problemas de pele em pets.', '2025-04-30', 54.99, 0.22, 130, 'produto_tratamentoPele.png'),  
...
(3, 9, 'Aromatizante', 'Produto aromatizante para ambientes com pets.', '2025-11-30', 14.99, 0.10, 200, 'produto_aromatizante.png'),  

  

(3, 9, 'Eliminador de Odor', 'Eliminador de odor para ambientes com pets.', '2025-10-15', 21.99, 0.15, 180, 'produto_eliminadorOdor.png'),  

  

(3, 8, 'Escova para Pelos', 'Escova para remoção de pelos em cães e gatos.', '2025-09-30', 9.99, 0.30, 150, 'produto_escovaPelos.png'),  

  

(2, 8, 'Repelentes', 'Repelente de insetos para pets.', '2025-08-31', 27.99, 0.20, 140, 'produto_repelente.png'),  

  

(3, 7, 'Areia Higiênica', 'Areia higiênica para gatos.', '2025-12-31', 12.99, 1.00, 250, 'produto_areiaHigienica.png'),  
...
(3, 10, 'Shampoo', 'Shampoo especial para pets.', '2025-12-31', 24.99, 0.50, 140, 'produto_shampooGato.png'),  

  

(3, 10, 'Condicionador', 'Condicionador para pelos de pets.', '2025-11-30', 27.99, 0.60, 130, 'produto_condicionador.png'),  

  

(3, 8, 'Hidratante', 'Hidratante para pele de pets.', '2025-10-15', 22.99, 0.40, 160, 'produto_hidratante.png'),  

  

(3, 8, 'Sabonete', 'Sabonete para higiene de pets.', '2025-09-30', 15.99, 0.20, 170, 'produto_sabonete.png'),  

  

(4, 4, 'Ração Seca para Cães', 'Ração seca para alimentação de cães.', '2025-12-31', 89.99, 5.00, 200, 'produto_racaoSecaCachorro.png'),  

  

(4, 4, 'Ração Úmida para Cães', 'Ração úmida para alimentação de cães.', '2025-11-30', 99.99, 3.00, 180, 'produto_racaoUmidaCachorro.png'),  

  

(4, 4, 'Ração Seca para Gatos', 'Ração seca para alimentação de gatos.', '2025-10-15', 79.99, 4.50, 190, 'produto_racaoSecaGato.png'),  

  

(4, 4, 'Ração Úmida para Gatos', 'Ração úmida para alimentação de gatos.', '2025-09-30', 89.99, 2.50, 170, 'produto_racaoUmidaGato.png'),  

  

(4, 4, 'Biscoitos para Cães', 'Biscoitos saborosos para cães.', '2025-08-31', 14.99, 0.25, 300, 'produto_biscoitoCachorro.png'),  

  

(4, 4, 'Ossinhos para Cães', 'Ossinhos crocantes para cães.', '2025-07-20', 19.99, 0.30, 280, 'produto_ossinho.png'),  

  

(4, 4, 'Bifinhos para Gatos', 'Bifinhos saborosos para gatos.', '2025-06-30', 17.99, 0.15, 320, 'produto_bifinhoGato.png'),  

  

(5, 10, 'Pato de Pelucia', 'Brinquedo de pelúcia em formato de pato.', '2025-12-31', 29.99, 0.35, 150, 'produto_pato.png'),  

  

(5, 10, 'Bola', 'Bola para diversão de cães e gatos.', '2025-11-30', 12.99, 0.20, 200, 'produto_bola.png'),  

  

(5, 10, 'Fresbee', 'Fresbee para brincar com cães.', '2025-10-15', 19.99, 0.25, 180, 'produto_fresbee.png'),  

  

(5, 10, 'Mordedor', 'Mordedor para cães.', '2025-09-30', 15.99, 0.30, 170, 'produto_mordedor.png'),  

  

(5, 10, 'Peixinho de Pelucia', 'Brinquedo de pelúcia em formato de peixinho.', '2025-08-31', 25.99, 0.30, 160, 'produto_peixinho.png'),  

  

(5, 10, 'Ratinho de Borracha', 'Brinquedo de borracha em formato de ratinho.', '2025-07-20', 14.99, 0.20, 190, 'produto_ratinhoBorracha.png'),  

  

(6, 7, 'Bebedouro', 'Bebedouro para cães e gatos.', '2025-06-30', 22.99, 1.00, 130, 'produto_bebedouro.png'),  

  

(6, 7, 'Comedouro', 'Comedouro para cães e gatos.', '2025-05-15', 19.99, 0.80, 140, 'produto_comedouro.png'),  

  

(6, 7, 'Coleira', 'Coleira para cães e gatos.', '2025-12-31', 18.99, 0.15, 200, 'produto_coleira.png'),  

  

(6, 7, 'Guia', 'Guia para passeios com cães.', '2025-11-30', 15.99, 0.20, 180, 'produto_guia.png'),  
...
(7, 3, 'Roupas de Inverno', 'Roupas para pets em dias frios.', '2025-09-30', 29.99, 0.50, 160, '´produto_roupinha.png'),  
...
(7, 8, 'Caminhas', 'Caminhas macias para pets.', '2025-11-30', 49.99, 1.20, 130, 'produto_caminha.png'),  

  

(6, 8, 'Cobertores', 'Cobertores quentes para pets.', '2025-10-15', 39.99, 1.00, 120, 'produto_cobertor.png'),  

  

(8, 9, 'Caixa de Transporte Plástico Médio', 'Caixa de transporte plástico de tamanho médio.', '2025-09-30', 79.99, 2.50, 90, 'produto_caixaTransporteMedia.png'),  

  

(8, 9, 'Caixa de Transporte Plástico Pequena', 'Caixa de transporte plástico de tamanho pequeno.', '2025-08-31', 59.99, 1.80, 100, 'produto_caixaTransportePequena.png'),  

  

(8, 9, 'Bolsa de Transporte Pano Médio', 'Bolsa de transporte de pano de tamanho médio.', '2025-07-20', 69.99, 1.50, 85, 'produto_bolsaTransporteMedia.png'),  

  

(8, 9, 'Bolsa de Transporte Pano Pequeno', 'Bolsa de transporte de pano de tamanho pequeno.', '2025-06-30', 49.99, 1.00, 95, 'produto_bolsaTransportePequena.png'),  

  

(8, 9, 'Casinha de Madeira Grande', 'Casinha de madeira grande para pets.', '2025-12-31', 149.99, 5.00, 40, 'produto_casinhaMadeira.png'),  

  

(8, 9, 'Casinha de Plástico Grande', 'Casinha de plástico grande para pets.', '2025-10-15', 129.99, 4.50, 45, 'produto_casinhaPlastico.png'); 
...
insert into cirurgia(id_especialidade, nome, valor) values
(11, 'Castração', 150.00),
(3, 'Correção de Luxação Patelar', 800.00),
(3, 'Fraturas Ósseas', 1500.00),
(5, 'Cirurgia de Catarata', 2500.00),
(11, 'Correção de Hernia Abdominal', 2000.00),
(11, 'Gastrectomia (Cirurgia de Estômago)', 3500.00),
(7, 'Correção de Estenose Uretral', 2000.00),
(2, 'Biópsia de Órgãos ou Tecidos', 1000.00),
(11, 'Cirurgia de Traqueostomia', 4000.00),
(11, 'Limpeza de Feridas', 200.00),
(7, 'Cirurgia de Cálculos Urinários', 1500.00),
(8, 'Cirurgia de Coluna Vertebral', 7000.00),
(3, 'Fixação de Fraturas Compostas', 3000.00),
(5, 'Descompressão Ocular (Glaucoma)', 2500.00),
(11, 'Remoção de Corpo Estranho no Esôfago', 1500.00),
(7, 'Cirurgia de Renal (Nefrectomia)', 4500.00),
(8, 'Descompressão da Medula Espinhal (Hérnia de Disco)', 6000.00),
(6, 'Correção de Doenças Cardíacas Congênitas', 8000.00),
(11, 'Esplenectomia (Remoção do Baço)', 5000.00),
(4, 'Remoção de Tumores Cutâneos (Neoplasias Cutâneas)', 1200.00),
(4, 'Remoção de cistos sebáceos', 800.00),
(4, 'Remoção Hematomas Auriculares', 600.00);


insert into vacina(nome, valor) values
('Vacina V8 (Cães)', 120.00),
('Vacina V10 (Cães)', 150.00),
('Vacina V11 (Cães)', 180.00),
('Vacina Anti-rábica (Cães e Gatos)', 80.00),
('Vacina Tríplice Felina (Gatos)', 120.00),
('Vacina Quádrupla Felina (Gatos)', 160.00),
('Vacina Para Cinomose (Cães)', 100.00),
('Vacina Para Hepatite Infecciosa (Cães)', 90.00),
('Vacina Contra Parvovirose (Cães)', 100.00),
('Vacina Contra Leptospirose (Cães)', 120.00),
('Vacina Contra Bordetella (Cães)', 150.00),
('Vacina Contra Calicivírus (Gatos)', 130.00),
('Vacina Contra Panleucopenia Felina (Gatos)', 120.00),
('Vacina Contra Leucemia Felina (Gatos)', 150.00),
('Vacina Contra Raiva Felina (Gatos)', 80.00);
