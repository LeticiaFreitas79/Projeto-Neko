<!--Objetivo do Código: Puxa as informações inseridas na página adm_produtoNovo e substitui no Banco de Dados. Redirecionar para adm_produtos.php-->
<!--Status do Código: Em desenvolvimento-->


<?php
    //CÓDIGO FEITO PELA ISA; a substituir ou editar.
