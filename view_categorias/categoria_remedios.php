<!--Objetivo do Código: Mostrar a categoria 'remédios' da Clínica Neko-->
...
<head>
    ...
    <title>Remédios | Clínica Neko</title>
</head>
<body>
    <?php
    ...
    <a class="navbar-brand" href="#">
      <img src="../view_img/banner_remedios.png" alt="Bootstrap" width="100%" height="100%">
    </a>
