<!--Objetivo do Código: Mostrar a categoria 'saúde' da Clínica Neko-->
...
<head>
    ...
    <title>Saúde | Clínica Neko</title>
</head>
<body>
    <?php
    ...
    <a class="navbar-brand" href="#">
      <img src="../view_img/banner_saude.png" alt="Bootstrap" width="100%" height="100%">
    </a>
    ...
    <div class="bloco-loja">
      <div class="card" style="width: 18rem;">
          <img src="<!--PHP: puxa o Imagem do Produto-->" class="card-imgSobre" alt="...">
        <div class="card-body">
