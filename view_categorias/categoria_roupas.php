...
<head>
    ...
    <title>Roupas e Camas | Clínica Neko</title>
</head>
<body>
    <?php
    ...
    <a class="navbar-brand" href="#">
      <img src="../view_img/banner_roupas.png" alt="Bootstrap" width="100%" height="100%">
    </a>
      ...
      <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
          <h5 class="card-title"><!--PHP: puxa o Nome do Produto--></h5>
            ...
            <p class="card-valor">R$<!--PHP: puxa o Nome do Produto--></p>
        </div><!--Fecha 'card-body'-->
      </div><!--Fecha 'card'-->
