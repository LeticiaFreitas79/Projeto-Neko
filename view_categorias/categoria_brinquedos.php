<!--Objetivo do Código: Mostrar a categoria 'brinquedos' da Clínica Neko-->
...
<head>
    ...
    <title>Brinquedos | Clínica Neko</title>
</head>
<body>
    <?php
    ...
    <a class="navbar-brand" href="#">
      <img src="../view_img/banner_brinquedos.png" alt="Bootstrap" width="100%" height="100%">
    </a>
