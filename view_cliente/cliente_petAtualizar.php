...
<head>
    ...
    <title>Atualizar Dados do Pet | Cliente Clínica Neko</title>
</head>
<body>
    ...
    <div class="bloco-formulario">
        <div class="bloco-cadastro">
            ...
            <div class="bloco-cabecalho">
                ...
                <h1 class="titulo">ATUALIZAR DADOS DO PET</h1>
                ...
                <div class="bloco-campos">
                    ...
                    <div class="bloco-btn">
                        <button class="btn-cadastro" type="submit"><!--PHP: cliente_pet_atualizar-->ATUALIZAR</button>
                    </div>
