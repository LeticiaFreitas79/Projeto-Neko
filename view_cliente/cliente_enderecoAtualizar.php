<!--Objetivo do Código: Exibe o formulário para editar um produto selecionado; os dados do produto devem aparecer nos inputs-->
...
<head>
    ...
    <title>Atualizar Endereço | Cliente Clínica Neko</title>
</head>
<body>
    <?php
    ...
    <div class="bloco-cadastro">
        ...
        <div class="bloco-cabecalho">
            ...
            <h1 class="titulo">ATUALIZAR ENDEREÇO</h1>
